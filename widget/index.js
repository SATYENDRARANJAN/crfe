...
exports.default = _default;
},{"@emotion/memoize":"z7su"}],"DsZo":[function(require,module,exports) {
...
var _default = He;
exports.default = _default;
},{"react-is":"H1RQ","react":"n8MK","shallowequal":"pz6A","@emotion/stylis":"gTWe","@emotion/unitless":"RtcD","@emotion/is-prop-valid":"ZRYH","hoist-non-react-statics":"ElIr","process":"pBGv"}],"a2Bw":[function(require,module,exports) {
var define;
...
},{}],"Kl7u":[function(require,module,exports) {
/**
 * @license React
...
},{"./cjs/react-jsx-runtime.production.min.js":"Kl7u"}],"UX1s":[function(require,module,exports) {
"use strict";
...
!function (e, t) {
  ...
  var p,
    ...
    le = v.showTooltip,
    ae = void 0 !== le && le,
    se = v.tooltipDefaultText,
    ce = void 0 === se ? "Your Rate" : se,
    de = v.tooltipArray,
    ue = void 0 === de ? [] : de,
    ve = v.tooltipStyle,
    pe = v.tooltipClassName,
    fe = void 0 === pe ? "react-simple-star-rating-tooltip" : pe,
    he = v.SVGclassName,
    ye = void 0 === he ? "star-svg" : he,
    me = v.titleSeparator,
    ge = void 0 === me ? "out of" : me,
    xe = v.SVGstyle,
    _e = v.SVGstorkeWidth,
    Ce = void 0 === _e ? 0 : _e,
    we = v.SVGstrokeColor,
    Ve = void 0 === we ? "currentColor" : we,
    ke = t.useReducer(r, {
      hoverIndex: 0,
      valueIndex: 0,
      ratingValue: _,
  ...
  var je = t.useMemo(function () {
    ...
    Re = function Re(e) {
      for (var t = e.clientX, o = e.currentTarget.children[0].getBoundingClientRect(), n = o.left, i = o.right, r = o.width, l = G ? i - t : t - n, a = je, s = Math.round(r / je), c = 0; c <= je; c += 1) {
        if (l <= s * c) {
          a = 0 === c && l < s ? 0 : c;
          break;
        }
  ...
  return e.jsxs("span", _o({
    ...
    children: [e.jsxs("span", _o({
      ...
      children: [e.jsx("span", _o({
        ...
        style: _o((p = {}, p[G ? "right" : "left"] = 0, p.color = ze(U) || J, p.transition = W ? "width .2s ease, color .2s ease" : "", p.width = "".concat(We, "%"), p), Z),
      ...
      style: _o((f = {}, f[G ? "marginRight" : "marginLeft"] = 20, f), ve)
    }, {
      children: (ue.length > 0 ? ze(ue) : Be) || ce
    }))]
  }));
};
},{"react/jsx-runtime":"plwR","react":"n8MK"}],"jzwH":[function(require,module,exports) {
"use strict";
...
var _reactSimpleStarRating = require("react-simple-star-rating");
...
var Review = function Review(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", null, review !== undefined && /*#__PURE__*/React.createElement("div", {
    className: "container"
  ...
  }, getContent(review.createdBy))), /*#__PURE__*/React.createElement("div", {
    className: "title"
  }, /*#__PURE__*/React.createElement("u", null, getContent(review.title))), /*#__PURE__*/React.createElement("div", {
    className: "rating"
  }, " ", /*#__PURE__*/React.createElement(_reactSimpleStarRating.Rating, {
    readonly: true,
    allowFraction: true,
    initialValue: review.rating
  }), /*#__PURE__*/React.createElement("div", {
    className: "rightContainer"
  }, /*#__PURE__*/React.createElement("div", null, (0, _moment.default)(review.createdAt).format("DD-MM-YYYY"))))), /*#__PURE__*/React.createElement("div", {
    className: "details"
  }, /*#__PURE__*/React.createElement("div", {
    className: "content"
  }, /*#__PURE__*/React.createElement("div", {
    className: "leftContainer"
  }, /*#__PURE__*/React.createElement("em", null, getContent(review.content)))), /*#__PURE__*/React.createElement("div", {
    className: "imagesContainer"
  }, review.images && review.images.length > 0 && review.images.map(function (img, index) {
    return /*#__PURE__*/React.createElement(ImageHeader, {
      key: index,
      src: img.url,
      alt: "Loading..."
    });
...
var Wrapper = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    width:100%;\n    display:flex;\n    // position:fixed;\n    // top:0px;\n    height:100px;\n    color:#fff;\n    background :", ";;\n    justify-content:space-between;\n    box-shadow: 0px 4px 9px rgba(0, 0, 0, 0.06);\n\n"])), function (props) {
  return props.primaryColor ? props.primaryColor : "#034c9d";
});
var ImageHeader = _styledComponents.default.img(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display:flex;\n    padding:20px;\n    max-width:100px;\n    max-height:100px;\n\n"])));
var ButtonTray = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    display:flex;\n    \n"])));
...
var Title = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    display: flex;\n    padding-top: 10px;\n    padding-left: 10px;\n    font-family:'Open Sans';\n    font-size: 30px;\n"])));
var SubTitle = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n    display: flex;\n    padding-top: 10px;\n    padding-left: 10px;\n    font-family:'Open Sans';\n\n\n"])));
var Text = _styledComponents.default.label(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral([" \ndisplay: flex;\nfont-family: \"Open Sans\";\nfont-size: 15px;\ncolor: #fff;\npadding-left: 50px;\n// height:105px;\ntext-align: left;\njustify-content:center;\nalign-items:center;\n"])));
},{"styled-components":"tFSs","./review.css":"vKFU","moment":"a2Bw","react-simple-star-rating":"UX1s"}],"ky7D":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _styledComponents = _interopRequireDefault(require("styled-components"));
var _Review = _interopRequireDefault(require("./customer/Review"));
var _templateObject;
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
var CustomerReviews = function CustomerReviews(_ref) {
  var reviews = _ref.reviews;
  return /*#__PURE__*/React.createElement(Inner, null, reviews && reviews.length > 0 && reviews.map(function (item, index) {
    return /*#__PURE__*/React.createElement(_Review.default, {
      key: index,
      review: item
    });
  }), reviews && reviews.length === 0 && /*#__PURE__*/React.createElement("div", null, "No Reviews found!"));
};
var Inner = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  padding: 20px 20px;\n  margin-bottom: 20px;\n  justify-content: center;\n  align-items: center;\n  background: #f8f8f8;\n  border-radius: 4px;\n"])));
var _default = CustomerReviews;
exports.default = _default;
},{"styled-components":"tFSs","./customer/Review":"jzwH"}],"lY9v":[function(require,module,exports) {
"use strict";
...
var _default = App;
exports.default = _default;
},{"./logo.svg":"xLDQ","./App.css":"vKFU","./Page":"ky7D"}],"FheM":[function(require,module,exports) {
var bundleURL = null;
